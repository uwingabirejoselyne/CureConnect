...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    ...
    address:{
      line1:'57th cross,Richardmond',
      line2:'Circle,Church,Road,Kigali',
    },
    gender:'Male',
    dob:'2000-01-20'
  })
    ...
    <div className=' max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
        isEdit
        ? <input className='bg-gray-100 max-w-52' type="text" value={userData.phone} onChange={e=> setUserData(prev => ({...prev,phone:e.target.value}))} />: <p className='text-blue-400'>{userData.phone}</p>
      }
